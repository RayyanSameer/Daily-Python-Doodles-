#This is a little cipher with decoding built in 

common_words = ["the", "be", "to", "of", "and", "a", "in", "that", "have", "it","for", "not", "on", "with", "he", "as", "you", "do", "at", "this"]

#The program uses these as a "cheat sheet" to see if a decrypted message looks like real English.

def encode(text,shift):
    result = ""
    for char in text :
        if char.isalpha():
            base = ord("a") if char.islower() else ord("A") #It finds the starting point of the alphabet
...
def brute_force(ciphertext):
    ...
    for shift in range(1,26):
        attempt = decode(ciphertext, shift)    
